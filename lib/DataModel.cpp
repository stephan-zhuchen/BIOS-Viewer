...
DataModel::DataModel(Volume *vol, string nm, string typ, string sbtyp):
    name(std::move(nm)),
    type(std::move(typ)),
...
void DataModel::setSectionModel(Volume *sec) {
    ...
    case EFI_SECTION_GUID_DEFINED:
        ...
        name = guidData->getNameFromGuid(guid, true);
    ...
    case EFI_SECTION_FREEFORM_SUBTYPE_GUID:
        name = guidData->getNameFromGuid(section->getSubTypeGuid(), true);
...
void DataModel::setFfsModel(Volume *file) {
    ...
    name = guidData->getNameFromGuid(ffs->getFfsGuid(), true);
    type = "File";
...
void DataModel::setFirmwareVolumeModel(Volume *vol) {
    ...
    name = guidData->getNameFromGuid(fv->getFvGuid(), true);
    type = "Volume";
