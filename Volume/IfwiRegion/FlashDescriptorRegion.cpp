...
void FlashDescriptorRegion::setInfoStr() {
    ...
    ss << setw(width) << "EC   region offset:" << hex << RegionList.at(FLASH_REGION_TYPE::FlashRegionEC).getBase()
       << "h\n"
       << setw(width) << "GbE  region offset:" << hex << RegionList.at(FLASH_REGION_TYPE::FlashRegionGbE).getBase()
       << "h\n"
       << setw(width) << "ME   region offset:" << hex << RegionList.at(FLASH_REGION_TYPE::FlashRegionMe).getBase()
       << "h\n"
       << setw(width) << "BIOS region offset:" << hex << RegionList.at(FLASH_REGION_TYPE::FlashRegionBios).getBase()
       << "h\n";
