...
void BiosViewerWindow::InitCustomMenu() {
...
void BiosViewerWindow::CleanupCustomMenu() {
...
void BiosViewerWindow::showTreeCustomMenu(QPoint pos) const {
    ...
    if (BiosData->RightClickedItemModel.getType() == "Volume" || BiosData->RightClickedItemModel.getType() == "File" || BiosData->RightClickedItemModel.getType() == "Section") {
        ...
        CustomMenu->addAction(extractBodyVolumeAction);
    }
    ...
    if (BiosData->RightClickedItemModel.getType() == "Region" && BiosData->RightClickedItemModel.getName() == "BIOS") {
        ...
        CustomMenu->addAction(ReplaceRegion);
    }
    ...
    CustomMenu->move(ui->treeWidget->cursor().pos());
    CustomMenu->show();
}
